...
const ContactSection = () => (
    <section data-aos="fade-up" className="w-full max-w-3xl mx-auto my-16 bg-white/80 rounded-2xl shadow-xl p-8 flex flex-col items-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 drop-shadow-md text-center">Liên hệ với chúng tôi</h2>
